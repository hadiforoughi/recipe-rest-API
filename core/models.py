...
def recipe_image_file_patch(instance,filename):
    ...
    return os.path.join('media/img/recipe/',filename)
...
class UserManager(BaseUserManager):
    ...
    def create_user (self,email,password=None,**extra_fields):
        ...
        if not email:
            raise ValueError('user must have email value')
...
class User(AbstractBaseUser,PermissionsMixin):
    """ custom user models that supports using email instead of using username """
